<div class="about">
	<div class="text">
		...
		<p>
			As a Full Stack Developer and IT Consultant with over five years of professional experience, I
			offer an ideal combination of technical expertise, strategic foresight, and the ability to
		...
		<p>
			...
			<strong>cross-platform applications (Web, Android, iOS) using Capacitor.js</strong>, ensuring
			seamless implementation across different platforms.
		</p>
		...
		<p>
			...
			such as <strong>AWS ECS, AWS Amplify, Docker, and GitHub Actions</strong>. These technologies
			enable <strong>efficient deployments</strong>, allowing more focus on development itself.
			Additionally, I have expertise in implementing
			<strong>secure authentication and authorization systems based on OAuth 2.0</strong>, ensuring
			<strong>accessibility (WCAG standards)</strong>
			and <strong>integrating payment systems with Stripe</strong>. With these capabilities, I help
			bring <strong>comprehensive and future-proof products</strong> to life.
		</p>
